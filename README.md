...
records the request/response **bodies** of the HTTP calls your service makes to a third-party API, **redacts
...
- **Body capture** on the `http`/`https` client path, size-capped and content-type gated.
